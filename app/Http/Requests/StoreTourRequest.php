...
final class StoreTourRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'price' => ['required_unless:is_inquiry_price,true,is_advertisement,true', 'nullable', 'numeric', 'min:0'],
            'currency' => ['sometimes', 'string', 'max:10'],
            'location' => ['required', 'string', 'max:255'],
            'max_participants' => ['required_unless:is_advertisement,true', 'nullable', 'integer', 'min:1'],
            'featured_image' => ['nullable', 'string', 'max:2048'],
            'sort_order' => ['sometimes', 'integer', 'min:0'],
            'is_active' => ['sometimes', 'boolean'],
            'automatic_payment' => ['sometimes', 'boolean'],
            'deposit_percentage' => ['sometimes', 'integer', 'min:1', 'max:100'],
            'is_inquiry_price' => ['sometimes', 'boolean'],
            'is_advertisement' => ['sometimes', 'boolean'],
            'is_flexible_duration' => ['sometimes', 'boolean'],
